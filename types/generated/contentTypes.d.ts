...
export interface ApiExamPaperExamPaper extends Schema.CollectionType {
  collectionName: 'exam_papers';
  info: {
    singularName: 'exam-paper';
    pluralName: 'exam-papers';
...
export interface ApiMessageMessage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['READ', 'UNREAD', 'DELETED']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubjectSubject extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    description: Attribute.Text;
    subject_categories: Attribute.Relation<
      'api::subject.subject',
      'manyToMany',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::exam-paper.exam-paper': ApiExamPaperExamPaper;
